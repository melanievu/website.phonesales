...
Route::get('forgotPassword', 'ResetPasswordController@forgotPass')->name('forgotPass');
Route::post('reset-password', 'ResetPasswordController@sendMail')->name('resetPass');
...
Route::group(['middleware' => 'CheckAdminLogin','prefix' => 'panel','namespace' => 'admin'], function() {
	...
	Route::resource('bill',HoaDonController::class);
});
